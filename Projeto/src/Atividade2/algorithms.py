import numpy as np
import abc
import src.Atividade2.optimizers as opt
import src.Atividade2.models as models
import src.Atividade2.stop_criteria as stop
from src.Atividade2.preprocessing import Preprocessing
...
class PLA(Algorithm):
    ...
    def __initialize(self, X):
        ...
        self.model.w = np.zeros((self.Xd.shape[1], 1))
        self.notify_started()